...
const coords = [54.048309, 27.083714];
      ...
      <div className="place-container">
        ...
        <Banner background="#F9E6A5">
          <div className="place-content">
            <p className="text">
              Праздник состоится на территории усадьбы "Ганка". Мы свяжемся с
              вами заранее, чтобы договориться о трансфере к месту проведения.
            </p>
            <div className="links">
              <a
                className="link"
              ...
              >
                <img
                  ...
                  src={InstaIcon.default}
                  alt="insta"
                />
              </a>
              <a
                className="link"
                href="https://yandex.by/maps/-/CDVoj-9a"
                target="_blank"
                rel="noreferrer"
              >
